  ...
  return (
    <div className="w-full bg-[var(--color-light)] pb-24">
          ...
          <div className="space-y-4">
            {events.map((event) => (
              <motion.div 
                key={event.id}
                variants={fadeUp}
                className="group flex flex-col md:flex-row justify-between items-start md:items-center p-6 md:p-8 bg-white border border-[var(--color-secondary)]/20 rounded-2xl hover:border-[var(--color-primary)] transition-all duration-300 shadow-sm hover:shadow-md"
              >
                ...
                <button className="w-full md:w-auto bg-[var(--color-dark)] text-[var(--color-light)] px-6 py-2.5 rounded-full text-sm font-semibold hover:bg-[var(--color-primary)] transition-colors duration-300">
      ...
      <section className="px-6 max-w-5xl mx-auto">
        ...
        >
          {/* Discord / Main Hub */}
          <motion.div variants={fadeUp} className="p-10 border border-[var(--color-secondary)]/20 rounded-3xl bg-[var(--color-dark)] text-[var(--color-light)] flex flex-col items-center text-center group hover:border-[var(--color-primary)] transition-colors duration-300">
            <div className="w-16 h-16 bg-[var(--color-light)]/10 rounded-full flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
            ...
            <button className="mt-auto border border-[var(--color-light)] text-[var(--color-light)] px-6 py-2.5 rounded-full font-semibold hover:bg-[var(--color-primary)] hover:border-[var(--color-primary)] transition-all duration-300">
              Join Server
            </button>
          </motion.div>

          {/* Twitter / Public Hub */}
          <motion.div variants={fadeUp} className="p-10 border border-[var(--color-secondary)]/20 rounded-3xl bg-white text-[var(--color-dark)] flex flex-col items-center text-center group hover:border-[var(--color-primary)] transition-colors duration-300 shadow-sm">
            <div className="w-16 h-16 bg-[var(--color-dark)]/5 rounded-full flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
            ...
            <button className="mt-auto border border-[var(--color-dark)] text-[var(--color-dark)] px-6 py-2.5 rounded-full font-semibold hover:bg-[var(--color-dark)] hover:text-[var(--color-light)] transition-all duration-300">
              Follow Us
            </button>
          </motion.div>
        </motion.div>
