        ...
        <section className="px-6 max-w-4xl mx-auto">
          ...
          >
            ...
            <motion.div variants={fadeUp} className="p-10 bg-zinc-950/50 backdrop-blur-md border border-white/10 text-white rounded-3xl shadow-2xl hover:border-[var(--color-primary)]/30 transition-all duration-300 flex flex-col justify-center text-center">
              ...
              <a href="https://tsu.owlphadao.com" target='_blank' className="text-xl text-[var(--color-primary)] font-semibold hover:text-[var(--color-primary)]/80 transition-colors">tsu.owlphadao.com</a>
            </motion.div>
            ...
            <motion.div variants={fadeUp} className="p-10 bg-zinc-950/50 backdrop-blur-md border border-white/10 text-white rounded-3xl shadow-2xl hover:border-[var(--color-primary)]/30 transition-all duration-300 flex flex-col justify-center items-center">
              ...
              <div className="flex flex-col space-y-4 w-full max-w-[220px]">
                <a href="https://x.com/OwlphaDAO_" target='_blank' className="flex items-center justify-center gap-4 text-zinc-400 hover:text-[var(--color-primary)] transition-colors duration-300 font-medium bg-zinc-900/50 p-4 rounded-xl border border-white/5 hover:border-[var(--color-primary)]/30">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                  X (Twitter)
                </a>
                <a href="https://discord.gg/62bnfwDnM" target='_blank' className="flex items-center justify-center gap-4 text-zinc-400 hover:text-[var(--color-primary)] transition-colors duration-300 font-medium bg-zinc-900/50 p-4 rounded-xl border border-white/5 hover:border-[var(--color-primary)]/30">
